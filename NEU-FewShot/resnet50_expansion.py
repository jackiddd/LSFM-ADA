...
# 初始化数据集和数据加载器  
train_dataset = ImageFolder(root='/root/NEU-FewShot/NEU-data/expansion-dataset-1shot/image-to-text/',
...
# 保存模型  
torch.save(model.state_dict(), '/root/NEU-FewShot/models/resnet50_expansion_1shot_image-to-text.pth')