...
# 初始化数据集和数据加载器
train_dataset = ImageFolder(root='/root/NEU-FewShot/data/5-shot+expansion-dataset',
...
# 保存模型
torch.save(model.state_dict(), '/root/NEU-FewShot/resnet50_5-shot+expansion.pth')